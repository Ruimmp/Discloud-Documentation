...
description: >-
  ...
  dependências essenciais para hospedar seu projeto Python na Discloud.
---
...
{% stepper %}
{% step %}
Certifique-se de que Python e pip estão instalados ([guia de instalação](../../ambiente-local/python.md)).
{% endstep %}
