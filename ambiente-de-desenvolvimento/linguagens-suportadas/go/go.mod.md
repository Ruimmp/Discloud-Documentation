...
description: >-
  ...
  dependências para aplicações Go no Discloud.
---
...
{% hint style="info" %}
Precisa do Go localmente? Veja o [guia do ambiente local](../../local-environment/golang.md).
{% endhint %}
...
- Você pode preferir um pequeno [Dockerfile](../../../configurations/discloud.config/dockerfile.md) para bloquear a versão da toolchain Go e o processo de build.

> 🔗 Exemplos: [Padrões de Dockerfile Go](../../../configurations/discloud.config/dockerfile.md#examples-of-applications-using-dockerfile)
