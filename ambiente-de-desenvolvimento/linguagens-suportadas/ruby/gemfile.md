---
description: >-
  Guia completo do Gemfile para bots Ruby e aplicações web (site/API) no
  Discloud.
---
...
get '/' do
	'Olá do app Sinatra no Discloud!'
end
...
Para bots, você normalmente NÃO precisa de `config.ru`; em vez disso, apenas aponte `MAIN` no [`discloud.config`](../../../configuracoes/discloud.config/) para sua entrada Ruby (ex.: `bot.rb`).
