...
Antes de fazer o upload de aplicações usando o **Bot da Discloud**, você deve primeiro **verificar sua conta** no servidor Discord da Discloud.
...
Se você AINDA **não** é verificado, os comandos que exigem verificação no Bot podem ficar indisponíveis até a normalização do sistema.

Enquanto isso, você pode fazer o upload e gerenciar suas aplicações por outros meios:

- [Painel de Controle](./painel-de-controle.md)
- [CLI](./cli.md)
- [Extensão para Visual Studio Code](./visual-studio-code.md)
- Bot do Discord (com limitações sem verificação)

Precisa de ajuda? Abra um **ticket de suporte** enviando qualquer mensagem na **DM do Bot de Tickets** ([abrir DM](https://discord.com/channels/@me/930852077045940224/)). Certifique-se de estar no [Servidor Discord da Discloud](https://discord.discloudbot.com/).

Fique no servidor para ser notificado quando o sistema de verificação voltar.

_(Aplicativo móvel ainda não disponível – não divulgado.)_
{% endhint %}

Quando o sistema de verificação voltar ao normal, o processo padrão será o abaixo:
