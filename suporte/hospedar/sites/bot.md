...
Para hospedar sites você precisa cumprir os seguintes [requisitos](bot.md#undefined):
...
Para hospedar, entre no canal de texto `commands` e digite `.upsite` ( ou `.upc` para usar o [discloud.config](broken-reference)).
