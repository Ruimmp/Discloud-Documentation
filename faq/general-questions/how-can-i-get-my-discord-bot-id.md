---
description: Saiba o que é o ID da Aplicação do Discord (Client ID) e como encontrá-lo no Discord Developer Portal.
---
...
{% hint style="info" %}
Este **não** é o mesmo que o **ID do App da Discloud**, que a Discloud gera internamente para sua aplicação hospedada. O **ID da Aplicação do Discord** vem do próprio Discord e identifica seu bot na plataforma do Discord — ele só é necessário para o fluxo de Configuração Rápida via o bot do Discord da Discloud.
{% endhint %}
...
{% hint style="warning" %}
O **ID da Aplicação** é uma **informação pública**, não há problema em compartilhá-lo. No entanto, mantenha seu **Bot Token** (encontrado na aba **Bot**) **em segredo**, pois qualquer pessoa com ele pode controlar seu bot.
{% endhint %}
...
Este ID é especificamente necessário ao usar o método de **Configuração Rápida** através do [Bot da Discloud](../how-to-host-using/discord-bot.md), durante o fluxo guiado, o bot solicitará que você insira o ID da Aplicação.
