---
description: Learn what the Discord Application ID (Client ID) is and how to find it in the Discord Developer Portal.
---
...
This ID is specifically required when using the **Quick Setup** method via the [Discloud Bot](../how-to-host-using/discord-bot.md), during the guided flow, the bot will prompt you to enter the Application ID.
