---
description: >-
  Manage your Discloud subscription (upgrade, cancel, reactivate) through the
  billing dashboard.
---
...
This page covers how to manage an existing paid subscription acquired through the Discloud website (Stripe). If you need to purchase a plan, see: [Plans & Support](../../about/donations.md).
...
{% stepper %}
{% step %}
Visit: [https://discloud.com/dashboard/billing](https://discloud.com/dashboard/billing) (log in if prompted).
{% endstep %}
...
<figure><img src="../../.gitbook/assets/Website-Subscription_Reactivate.png" alt="" width="563"><figcaption></figcaption></figure>
