...
description: >-
  ...
  falham em permanecer online no Discloud.
---

# Diagnosticando Aplicações Offline

Se sua aplicação **encerra inesperadamente** no Discloud, é importante analisar **o que pode estar causando o problema**. Este guia ajudará você a **identificar, depurar e resolver** problemas comuns relacionados a aplicações indo offline.
...
* Pode estar relacionado à **política anti-ghost app do Discloud** para planos gratuitos.
...
✔ Considere **aumentar a RAM** no seu arquivo [`discloud.config`](../../configuracoes/discloud.config/).
{% endhint %}
...
✔ **Teste localmente** antes de implantar no Discloud.
{% endhint %}

{% hint style="warning" %}
#### **Limitações do Plano Gratuito**

O plano gratuito do Discloud **pode suspender aplicações inativas** para liberar recursos.
...
📌 **Um erro comum que desenvolvedores cometem é dizer:** _"Funciona na minha máquina mas não no Discloud."_

Lembre-se, **o Discloud opera em um ambiente Linux**. Sua aplicação deve ser **adaptada para rodar no ambiente alvo**, não apenas na sua máquina local.
...
* Se a aplicação usa mais memória do que alocada, o Discloud **encerra forçadamente**.
...
✔ **`ffmpeg` ausente** → Adicione `ffmpeg` nas dependências [`APT`](../../configuracoes/discloud.config/apt.md).\
...
## 🛰️ **Verifique o Status do Discloud**

Se nenhuma das soluções acima resolver o problema, verifique a página de status do Discloud ou o canal Discord para quaisquer problemas relatados em todo o sistema. Problemas temporários de infraestrutura podem impactar a disponibilidade da sua aplicação.

* [**Página de Status do Discloud**](https://status.discloud.app/)
* [**Canal Discord do Discloud**](https://discord.com/channels/584490943034425391/694744729731989605)
