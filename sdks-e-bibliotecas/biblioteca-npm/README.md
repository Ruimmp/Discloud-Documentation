...
**discloud.app** é a biblioteca oficial **Node.js** para interagir com a **API do Discloud**. Esta poderosa biblioteca permite gerenciar suas aplicações programaticamente, realizar uploads, monitorar status, controlar o ciclo de vida da aplicação e muito mais, tudo a partir de seus projetos JavaScript ou TypeScript.
