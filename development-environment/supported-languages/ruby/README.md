...
🔗 **Precisa de ajuda para configurar seu** [**`Gemfile`**](gemfile.md) **ou encontrar o** [**arquivo principal**](../../../faq/general-questions/em-andamento-qual-e-o-arquivo-principal.md)**?**
