---
description: >-
  Upgrade or contribute to support platform sustainability and access higher
  resource tiers.
icon: sack-dollar
---
...
{% hint style="info" %}
If you only need to manage (cancel / reactivate) an existing subscription, see: [Subscription Management](../faq/general-questions/subscription-management.md)
{% endhint %}
...
{% stepper %}
{% step %}
Visit: [https://discloud.com/plans](https://discloud.com/plans)
{% endstep %}
...
<figure><img src="../.gitbook/assets/Website-Plans.png" alt="Plans page screenshot"><figcaption><p>Plan selection interface.</p></figcaption></figure>
