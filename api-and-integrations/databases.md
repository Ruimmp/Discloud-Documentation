...
Open a [support ticket](databases.md#overview) in the [Discord server](databases.md#overview) with the engine name, version, and use case. The team evaluates feasibility and may add it to the catalog.
{% endhint %}
