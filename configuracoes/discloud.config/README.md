---
description: >-
  Aprenda tudo sobre o arquivo de configuração para hospedar aplicações no
  Discloud.
icon: gear
---
...
É um arquivo de configuração que simplifica o processo de implantação das suas aplicações no Discloud. Com este arquivo, você pode configurar facilmente as informações para cada aplicação que você faz upload no serviço de hospedagem.
...
O arquivo `discloud.config` <mark style="color:yellow;">**deve estar na**</mark> [<mark style="color:yellow;">**raiz**</mark> <mark style="color:yellow;"></mark><mark style="color:yellow;">do seu projeto</mark>](../../faq/general-questions/what-is-the-root-of-the-project.md).
...
- `MAIN` - deve conter o caminho para o [arquivo principal](../../faq/general-questions/wip-what-is-the-main-file.md) da sua aplicação.
...
> Veja abaixo exemplos de arquivos **discloud.config** para [🤖 Bots Discord](./#discord-bots), [🌐 Sites e APIs](./#websites-and-apis), e [🐋 Aplicações com Dockerfile](./#applications-with-dockerfile).
...
{% tab title="🐋 Aplicações com Dockerfile" %}
{% tabs %}
{% tab title="🍃 Servidor MongoDB" %}
