...
> Veja abaixo exemplos de arquivos **discloud.config** para [🤖 Bots Discord](./#bots-discord), [🌐 Sites e APIs](./#sites-e-apis), e [🐋 Aplicações com Dockerfile](./#aplicacoes-com-dockerfile).
