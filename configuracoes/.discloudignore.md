...
✔ **Acelera implantações** – Menos dados significam **processamento mais rápido**.\
✔ **Mantém implantações limpas** – Impede que arquivos sensíveis ou desnecessários sejam incluídos.

🔑 **Principais diferenças do `.gitignore`**\
**• Sem barras finais** para diretórios (use `node_modules`, não `node_modules/`).\
...
O arquivo `.discloudignore` <mark style="color:yellow;">**deve estar na**</mark> [<mark style="color:yellow;">**raiz**</mark> <mark style="color:yellow;"></mark><mark style="color:yellow;">do seu projeto</mark>](../faq/general-questions/what-is-the-root-of-the-project.md).
