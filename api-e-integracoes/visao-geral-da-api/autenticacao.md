...
{% stepper %}
{% step %}
Você gera um [token](../../faq/perguntas-gerais/como-obter-o-meu-token-da-api-da-discloud.md) único vinculado à sua conta.
{% endstep %}
...
{% hint style="warning" %}
Nunca commite seu token (ex. no Git). Armazene-o em variáveis de ambiente ([`.env`](../../faq/perguntas-gerais/em-andamento-arquivo-.env.md), segredos CI/CD, etc.).
{% endhint %}
